    ...
    const props = defineProps({
        projects: Array,
        end_point_contract: String
    });

    const user = usePage().props.auth.user;
    const seller_name = user.name
    const end_point_contract = usePage().props.end_point_contract
    ...
    const submit = async () => {
        // console.log(JSON.stringify(form.data()))
            ...
            const response = await fetch(end_point_contract +'api/register-and-point-to-match', {
                method: 'POST',
                headers: {
            ...
            <div class="flex flex-col items-center justify-center mt-7 px-2">
                ...
                <form @submit.prevent="submit">
                    ...
                    <div>
                        ...
                        Buyer's GMI does not match the required GMI for selected project.
                        </p>
                        <hr>
