...
const props = defineProps({ buyers: Array, users: Array });
const form = ref({
  reference_code: '',
  first_name: '',
  middle_name: '',
      ...
      <div v-for="buyer in buyers" :key="buyer.id" class="card mb-2">
        <div class="card-body">
          ...
          <p class="card-text">
            ...
            <strong>Seller Code:</strong> {{ buyer.landline.split('/')[0] }}<br>
            <strong>Seller Name:</strong> {{ buyer.landline.split('/')[1] }}<br>
          ...
          <table class="table table-bordered table-hover">
            ...
            <tbody>
              <tr v-for="buyer in buyers" :key="buyer.id">
                ...
                <td>{{ buyer.landline.split('/')[0]}}</td>
                <td>{{ buyer.landline.split('/')[1] }}</td>
